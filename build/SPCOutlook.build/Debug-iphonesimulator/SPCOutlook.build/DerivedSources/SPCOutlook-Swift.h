...
#ifndef SPCOUTLOOK_SWIFT_H
#define SPCOUTLOOK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SPCOutlook",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SPCOutlook15LocationService")
...
@class CLLocation;
@interface LocationService (SWIFT_EXTENSION(SPCOutlook)) <CLLocationManagerDelegate>
